...
function ModalShipment({ isOpen, onClose, order }: ShipmentModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch(`${apiUrl}/shipments/${order?.shipment.id}`, {
      method: 'PATCH',
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        id="fullName"
                        disabled
                        placeholder={order?.user.username || 'Devid'}
                        defaultValue={order?.user.username || 'Devid'}
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        id="phoneNumber"
                        disabled
                        placeholder={String(order?.shipment.address.telefono) || 'Default Phone'}
                        defaultValue={String(order?.shipment.address.telefono) || 'Default Phone'}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="emailAddress"
                      disabled
                      placeholder={order?.user.email || 'Email'}
                      defaultValue={order?.user.email || 'Email'}
                    />
                  </div>
                </div>
              </form>
              ...
              <form  onSubmit={handleSubmit}>
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-2.5 pl-3 pr-4.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                      type="text"
                      name="status"
                      value={formData.status}
                      onChange={handleChange}
                      placeholder={order?.shipment.status || " in transito"}
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder={order?.shipment.carrier || ""}
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder={order?.shipment.trackingNumber || ""}
