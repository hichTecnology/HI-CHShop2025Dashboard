...
const  ModalMessage : React.FC<modalMessageProps> =({link}) => {
  ...
  return (
    <div onClick={ () => deleteModal()} className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center ">
    <div className="p-8  w-96  rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
      <div className="text-center">
        ...
        <div className="mt-2 px-7 py-3">
          <p className="text-lg text-gray-500 "> Ok e Stato Aggiunto con sucesso</p>
        </div>
